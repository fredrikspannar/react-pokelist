...
export default function PokeCard({name, id, style, handleToggleFavorite=null, favorites=[]}) {
    ...
    return (
        <div className="p-6 bg-slate-600 m-4 text-white w-56 h-64 flex flex-col items-center justify-center align-middle">
            <div ref={imageRef} className="hidden">
                ...
                <Link to={`/pokemon/${id}/${name}`} title={`Show details for ${name}`}>
